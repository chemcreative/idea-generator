...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/idea-generator)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/idea-generator
```

A live public deployment of this template is available at [https://idea-generator.templates.workers.dev](https://idea-generator.templates.workers.dev)
